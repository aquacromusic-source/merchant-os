  ...
  return (
    <Page title="">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '340px 1fr', gap: 20, alignItems: 'start' }}>
        ...
        {/* DROITE — Globe Cobe */}
        <div style={{ background: '#000000', borderRadius: 12, overflow: 'hidden', position: 'sticky', top: 16, padding: '16px 0', border: 'none', height: 'calc(100vh - 100px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <GlobeAceternity
            markers={[
